...
/* Displays product title, breadcrumbs, brand, rating, features */
/* Left column of ProductDetailPage */
  ...
  return (
    <div className="product-info">
      ...
      <div className="product-info__stock">
        <span
          className={`product-info__stock-dot ${inStock ? 'product-info__stock-dot--in' : 'product-info__stock-dot--out'}`}
        />
        <span>
          {inStock
